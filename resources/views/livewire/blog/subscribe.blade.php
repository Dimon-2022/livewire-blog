<div class="bg-indigo-600 rounded-lg p-8">
    <div class="max-w-xl mx-auto text-center">
        ...
        <form wire:submit="subscribe" class="flex flex-col sm:flex-row gap-3">
            <input type="email" wire:model="email" placeholder="Enter your email" class="flex-1 text-white rounded-md border-transparent focus:border-white focus:ring-white"/>
            <button type="submit" class="px-6 py-3 bg-white text-indigo-600 rounded-md font-semibold hover:bg-indigo-50 transition">Subscribe</button>
        </form>
